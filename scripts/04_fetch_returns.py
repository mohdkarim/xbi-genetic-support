  ...
  processed/stock_prices_daily.json
    {
      "AMGN": {
        ...
        "price_end": 285.41,        # Close on 2026-04-01 (or last trade date)
...
END_DATE   = "2026-04-02"  # Download through; last trading day = Apr 1, 2026
ENTRY_DATE = pd.Timestamp("2020-01-02")  # First trading day of 2020
EXIT_DATE  = pd.Timestamp("2026-04-01")  # Last Friday before analysis cutoff
...
def main():
    ...
    print(f"      Entry date: 2020-01-02 | Exit date: 2026-04-01")
